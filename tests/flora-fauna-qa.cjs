...
const phase=process.env.ROOM_PHASE||'after',out=path.join(__dirname,'artifacts/flora-fauna',phase);
...
(async()=>{
 ...
 for(const [device,season,mode] of [['desktop','summer','day'],['desktop','spring','day'],['desktop','spring','dusk'],['desktop','autumn','day'],['desktop','winter','day'],['mobile','summer','day'],['mobile','spring','day']]){
