...
window.WorldState=(()=>{
 ...
 seasons.spring.flower={enabled:true,count:216,palette:['#fff5df','#f6dfa0','#efd1dc','#cdc2ee','#b6d6ee'],speciesMix:['daisy','buttercup','campanula','lavender'],minScale:.78,maxScale:1.13,clusterCount:8,clusterRadius:1.05,windStrength:.016,bloomAmount:.86,stem:'#629048'};
 seasons.summer.flower={enabled:true,count:132,palette:['#f9f1db','#efc154','#ea9e82','#9d9bd3'],speciesMix:['daisy','buttercup','campanula','lavender'],minScale:.88,maxScale:1.25,clusterCount:6,clusterRadius:1.10,windStrength:.013,bloomAmount:1.06,stem:'#3c6638'};
